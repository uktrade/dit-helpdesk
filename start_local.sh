...
#pipenv run python manage.py loaddata countries_data
#pipenv run python manage.py pull_api_update
pipenv run python manage.py prepare_import_data
pipenv run python manage.py prepare_search_data
pipenv run python manage.py scrape_section_hierarchy --delete-old true
#pipenv run python manage.py import_rules_of_origin --data_path "import"
#pipenv run python manage.py import_regulations
pipenv run python manage.py import_search_keywords -f output/commodity_category_all_with_synonyms_greenpage.csv
#pipenv run python manage.py search_index --delete
#pipenv run python manage.py search_index --populate
## -------------------------------------------
...
# ----------------- commands ----------------
#pipenv run manage.py runserver_plus 0.0.0.0:8000
