...
class SearchKeywordsImporter:
    ...
    def __init__(self):
        ...
        self.subheading_codes = [subheading.commodity_code for subheading in SubHeading.objects.all()]
        self.commodity_codes = [commodity.commodity_code for commodity in Commodity.objects.all()]
    ...
    def load(self, file_path):
        ...
        for item in data:
            ...
            if "keywords" in instance_data[commodity_code].keys() \
                        and isinstance(instance_data[commodity_code]["keywords"], list):
