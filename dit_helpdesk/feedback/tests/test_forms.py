...
class FeedbackFormTestCase(TestCase):
    ...
    #         reverse("feedback-view"), {"name": "test", "email": "test@test.com"}
    #     )
    ...
    #     self.assertFalse(form.is_valid())
    #     self.assertEquals(
    #         form.errors, {"message": ["Message needs to be less than 1,000 characters"]}
    #     )
    ...
    #     message = "This is a test message"
    #     resp = self.client.post(
    #         reverse("feedback-view"), {"message": message, "email": "test@test.com"}
    #     )
    #     self.assertEquals(resp.status_code, 200)
    #     self.assertEquals(resp.resolver_match.url_name, "feedback-view")
    #
