...
class HierarchyBuilderTestCase(TestCase):
    ...
    def test_instance_builder_for_chapter(self):
        ...
        logger.info("TEST builder for chapter")
        logger.info("TEST {0}".format(dir(chapter_model)))
        ...
        logger.info("TEST {0}".format(dir(chapter_instance)))
        # chapter_instance.save()
        # self.assertEqual(chapter_instance.section_id, 1)
