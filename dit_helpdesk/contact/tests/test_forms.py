...
class ContactFormTestCase(TestCase):
    ...
    def test_submit_empty_message_form_returns_required_fields(self):
        pass
        # resp = self.client.post(reverse('contact-view'), {'name': 'test', 'email_address': 'test@test.com'})
        # self.assertEquals(resp.status_code, 200)
        # self.assertEquals(resp.resolver_match.url_name, 'contact-view')
        #
    ...
    def test_form_with_missing_name(self):
        pass
        # message = 'This is a test message'
        # resp = self.client.post(reverse('contact-view'), {'message': message, 'email': 'test@test.com'})
        # self.assertEquals(resp.status_code, 200)
        # self.assertEquals(resp.resolver_match.url_name, 'contact-view')
        #
        # form = resp.context['form']
