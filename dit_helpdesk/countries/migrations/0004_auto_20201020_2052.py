...
def populate_trade_relations(apps, schema_editor):
    TradeRelation = apps.get_model('countries', 'TradeRelation')
    ...
    for item in trade_data:
        ...
        try:
            ...
            logger.error("Could not find country with country_code=%s", country_code)
        else:
            TradeRelation.objects.create(
                country=country,
...
def unpopulate_trade_relations(apps, schema_editor):
    TradeRelation = apps.get_model('countries', 'TradeRelation')

    TradeRelation.objects.all().delete()


class Migration(migrations.Migration):

    dependencies = [
        ('countries', '0003_traderelation'),
    ]

    operations = [
        migrations.RunPython(populate_trade_relations, unpopulate_trade_relations),
    ]
