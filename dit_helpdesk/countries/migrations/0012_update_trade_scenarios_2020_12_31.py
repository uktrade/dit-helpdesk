# Generated by Django 2.2.13 on 2020-12-31 14:40
...
def y_or_n(val):
    return val == "Y" or val == "TRUE"


def update_trade_scenarios(apps, schema_editor):
    Country = apps.get_model("countries", "Country")

    csv_file_path = os.path.join(DATA_DIR, "trade-scenarios-2020-12-31.csv")
...
class Migration(migrations.Migration):
    ...
    dependencies = [("countries", "0011_auto_20201224_1413")]
