...
//  computed: {
//    treeData2: function() {
//        var data = {'name': 'root', 'children': [], 'node_id': "root"}
//        for (const [key, value] of Object.entries(this.sectionData)) {
//            // NOTE: this should really use ordered keys
...
//     for(var sectionId=1; sectionId <= 21; sectionId++){
//        axios.get('/section_data/'+(sectionId.toString()))
//          .then(response => {
//            this.sectionData[sectionId] = response.data
//          })
//     }

     axios.get('/hierarchy_data_cached/')
      .then(response => {
